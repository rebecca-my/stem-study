...
class SkipGramModel ():
    def __init__(self, optimizer=Adagrad(learning_rate=0.02879), embed_dim=218, simple=True):
    ...
    def train(self, filepath=None):
        if filepath is not None:
            ...
            callbacks_list = None
        self.model.fit(train_generator(), validation_data=valid_generator(), steps_per_epoch = len(self.train_students),
